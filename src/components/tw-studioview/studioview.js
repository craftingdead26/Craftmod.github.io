...
StudioView.STUDIO_API = 'https://projects.pend.com/api';

// The URL to download thumbnails from.
// $id is replaced with the project's ID.
StudioView.THUMBNAIL_SRC = 'https://projects.puinmod.com/api/pmWrapper/iconUrl?id=$id';

// The URL for project pages.
// $id is replaced with the project ID.
StudioView.PROJECT_PAGE = 'https://studio.pengmod.com/#$id';
